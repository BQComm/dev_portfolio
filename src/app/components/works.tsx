...
const Works: FunctionComponent = () => {
  return (
    <div className="relative w-full min-h-screen overflow-x-auto flex lg:flex-row md:flex-col sm:flex-col gap-[20px] py-[9%] px-[67px] box-border items-center justify-between text-center text-[32px] text-darkslategray font-covered-by-your-grace">
